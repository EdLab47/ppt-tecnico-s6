...
const checklistItems = [
  { id: 'check1', label: 'Descargué ambos archivos y los guardé en la carpeta de Tareas' },
  { id: 'check2', label: 'Leí rápidamente la historia para saber qué problema hay en la ciudad' },
  { id: 'check3', label: 'Configuré Comic Sans MS (18 o 20 pts) en toda la presentación' },
  { id: 'check4', label: 'Creé la portada limpia (sin imágenes) con todos los datos' },
  { id: 'check5', label: 'Para cada imagen, inserté una diapositiva nueva' },
  { id: 'check6', label: 'Renglón 1: Escribí qué está pasando en esa parte de la historia' },
  { id: 'check7', label: 'Renglón 2: Mencioné qué aparato o componente electrónico aparece' },
  { id: 'check8', label: 'Renglón 3: Expliqué qué problema tiene ese aparato' },
  { id: 'check9', label: 'Renglón 4: Escribí qué están haciendo los personajes para arreglarlo' },
  { id: 'check10', label: 'Renglón 5: Di una opinión sobre por qué es importante ese arreglo' },
  { id: 'check11', label: 'NO copié frases del PDF (lo expliqué como si fuera a un amigo)' },
  { id: 'check12', label: 'Revisé coherencia, ortografía y puntuación' },
  { id: 'check13', label: 'Guardé con el nombre correcto en la carpeta de Tareas' },
];
  ...
  return (
    <div className="bg-white p-8 rounded-3xl shadow-lg mb-10">
      <h3 className="text-2xl font-bold text-indigo-600 mb-6 flex items-center gap-3">
        <i className="fas fa-clipboard-check"></i> Lista de Verificación del Proceso
      </h3>
